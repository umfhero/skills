...
- "not only... but also..." (extremely frequent, a defining pattern across both samples)
- "Lastly,"
- "this in turn"
...
**Important:** In casual-professional writing, "Additionally", "Furthermore", "not only... but also..." and other formal connectors DO NOT APPEAR. Using them in a LinkedIn post or casual explanation is a register mismatch.
...
- "not only... but also..." (his most characteristic academic construction)
...
- No formal connectors at all (no "Additionally", no "Furthermore", no "not only... but also...")
...
- Binary contrasts ("Not X. Y." / "The answer isn't X. It's Y.")
